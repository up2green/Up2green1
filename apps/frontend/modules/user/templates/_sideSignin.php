<form id="signinForm" action="<?php echo url_for('@sf_guard_signin') ?>" method="post" class="clearfix">
    <ul class="menu">
        ...
        <li><input tabindex="2" type="password" id="signin_password" name="signin[password]" size="15" value="<?php echo __("Mot de passe") ?>" placeholder="<?php echo __("Mot de passe") ?>" /></li>
        <li><input tabindex="1" type="text" name="signin[username]" id="signin_username" size="15" value="<?php echo __("Nom d'utilisateur") ?>" placeholder="<?php echo __("Nom d'utilisateur") ?>" /></li>
    </ul>
