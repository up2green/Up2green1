...
CREATE TABLE profil (id INT AUTO_INCREMENT, user_id INT UNIQUE NOT NULL, mail VARCHAR(50) NOT NULL UNIQUE, credit INT DEFAULT 0 NOT NULL, is_newsletter TINYINT DEFAULT 0 NOT NULL, culture VARCHAR(7) DEFAULT 'fr_FR', INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
