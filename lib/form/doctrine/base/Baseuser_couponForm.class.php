...
/**
 * user_coupon form base class.
 *
 * @method user_coupon getObject() Returns the current form's model object
 *
 * @package    up2green
 * @subpackage form
 ...
 */
abstract class Baseuser_couponForm extends BaseFormDoctrine
{
