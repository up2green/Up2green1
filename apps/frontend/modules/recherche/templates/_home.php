...
<div id="home">
	...
	<div class="module statistiques">
		...
		<div class="content">
			...
			<p class="center tooltiped" tooltip="<?php echo __("Les forêts sont reconnues pour être de véritables puits de carbone.<br /> A titre indicatif, d’après l’ONU, pendant sa croissance un arbre capte en moyenne 12 kgs de CO2 par an et rejette l’oxygène nécessaire à la respiration dune famille de 4 personnes") ?>" style="padding:10px 0;">
